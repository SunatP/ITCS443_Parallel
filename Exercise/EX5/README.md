...
**threadIdx.x** คือ ตัว **Pointer** ที่จะชี้/ระบุตำแหน่งภายใน **block** แกน **X** ซึ่ง ตรง **.x** สามามารถเปลี่ยนเป็น **Y** หรือ **Z** ได้
...
threadIdx.x ตัวที่ 1 หรือ thread 0 (X = 1) = threadIdx.y = threadIdx.Z มีค่า 0 
